    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <section className="mx-auto flex w-full max-w-7xl -translate-y-4 flex-col-reverse items-center justify-center gap-10 sm:flex-row-reverse sm:items-center lg:-translate-y-8 lg:gap-16">
          ...
          <div className="flex max-w-4xl flex-1 flex-col items-center gap-6 text-center sm:items-start sm:text-left">
            ...
            <div className="flex flex-row gap-3 pt-2">
              <a
                className="inline-flex items-center justify-center whitespace-nowrap rounded-full bg-highlight px-4 py-3 text-xs font-medium text-background transition-colors hover:bg-foreground sm:px-5 sm:text-sm"
                href="#contact"
              >
                Contact
              </a>
              <a
                className="inline-flex items-center justify-center whitespace-nowrap rounded-full border border-foreground/40 px-4 py-3 text-xs font-medium text-foreground transition-colors hover:border-highlight hover:text-highlight sm:px-5 sm:text-sm"
      ...
      <section id="skills" className={skillsSectionClass}>
        <div className={`${containerClass} gap-10`}>
          ...
          <div className="grid w-full max-w-6xl grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-5 lg:grid-cols-6">
            {skills.map((skill) => (
              <article
                key={skill.name}
                className="flex aspect-square flex-col items-center justify-center gap-2 rounded-lg border border-foreground/15 bg-offset p-3 text-center transition-colors hover:border-highlight sm:gap-3 sm:p-4"
              >
                <div
              ...
              <div className="flex flex-col gap-7">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <a
                      className="break-all text-sm text-foreground/55 underline-offset-4 hover:underline"
                      href="mailto:bianca06162007@gmail.com"
                    >
